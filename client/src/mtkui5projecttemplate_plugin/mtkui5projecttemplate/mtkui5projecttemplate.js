	...
	return function () {
		...
		return {
			...
			onBeforeTemplateGenerate: function (templateZip, model) {
				...
				this._setProjectQualifiedNameInModel(model);
				...
				templateZip.files["webapp/controller/List.controller.js.tmpl"].name = "webapp/controller/" + model.basicSAPUI5ApplicationProject.parameters
					.name1.value + ".controller.js.tmpl";
				templateZip.files["webapp/controller/Detail.controller.js.tmpl"].name = "webapp/controller/" + model.basicSAPUI5ApplicationProject.parameters
					.name2.value + ".controller.js.tmpl";
				templateZip.files["webapp/view/List.view.xml.tmpl"].name = "webapp/view/" + model.basicSAPUI5ApplicationProject.parameters.name1.value +
					".view.xml.tmpl";
				templateZip.files["webapp/view/Detail.view.xml.tmpl"].name = "webapp/view/" + model.basicSAPUI5ApplicationProject.parameters.name2.value +
					".view.xml.tmpl";
			...
			_setProjectQualifiedNameInModel: function (oModel) {
				var sProjectNamespace = oModel.basicSAPUI5ApplicationProject.parameters.namespace.value;
				oModel.fullyQualifiedProjectName = sProjectNamespace ? sProjectNamespace + "." + oModel.projectName : oModel.projectName;
			},
			...
			addNeoDestinations: function (oModel) {
				...
				destinations.push(localODataService);
